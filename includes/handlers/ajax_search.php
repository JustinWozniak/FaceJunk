...
// following 2 variables are passed in from getLiveSearchUsers function in gozo.js
$query = $_POST['query'];
$userLoggedIn = $_POST['userLoggedIn'];

// explode function splits strings up into slots in an array
$names = explode(" ", $query);

//If query contains an underscore, assume user is searching for usernames
if (strpos($query, '_') !== false) // strpos returns position it finds underscore in
