...
<<<<<<< HEAD
					$value = '<br><iframe id="youtube_iframe" src=\'" . $value ."\'></iframe><br>';
=======
		...
		if (mysqli_num_rows($data_query) > 0) {
			...
			while ($row = mysqli_fetch_array($data_query)) {
				...
				if ($user_logged_obj->isFriend($added_by)) {
					...
					//adds the delete button to posts
				...
				<script>
					$(document).ready(function() {
						$('#post<?php echo $id; ?>').on('click', function() {
							bootbox.confirm("HEYYYYY!!!!! you sure you want to delete this post?", function(result) {
			...
			<input type='hidden' class='noMorePosts' value='false'>";
				...
				$str .= "<input type='hidden' class='noMorePosts' value='true'><p style='text-align: centre;'> Imagine that!!!   You reached the bottom!!!!   No More Posts to show! </p>";
		}
